        ...
        {productsData?.map((productData, index) => {
          ...
          return (
            <div key={index} className="relative flex p-[16px] shadow-[0_4px_20px_-0px_rgba(0,0,0,0.1)] rounded-[10px] flex-col gap-[24px] max-w-[650px] pt-[64px]">
              ...
              <div onClick={()=> handleOpenModel(productData?.id)} className="cursor-pointer absolute top-[20px] right-[20px] gap-2 text-[#303031] font-[500] flex items-center justify-center p-[12px] bg-[#EFB749] rounded-[8px]">
                Edit
                <svg
